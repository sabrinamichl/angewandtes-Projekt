...
### QQ-Anand
```{r}
lm1 <- lm(QQ_Anand_mean ~ OC_A_mean + BZG, data=d_work_s)
summary(lm1)
```
...
### Gesamte QQ-Skala
```{r}
lm2 <- lm(QQ_Gesamt_mean ~ OC_A_mean + BZG, data=d_work_lm)
summary(lm2)
```
...
### QQ-Anand
```{r}
lm3 <- lm(QQ_Anand_mean ~ IS_mean + BZG, data=d_work_lm)
summary(lm3)
```

### Gesamte QQ-Skala
```{r}
lm4 <- lm(QQ_Gesamt_mean ~ IS_mean + BZG, data=d_work_s)
summary(lm4)
```
...
### QQ-Anand
```{r}
lm5 <- lm(QQ_Anand_mean ~ CPE_mean + BZG, data=d_work_s)
summary(lm5)
```

### Gesamte QQ-Skala
```{r}
lm6 <- lm(QQ_Gesamt_mean ~ CPE_mean + BZG, data=d_work_s)
summary(lm6)
```
...
### QQ-Anand
```{r}
lm7 <- lm(QQ_Anand_mean ~ PS_mean + BZG, data=d_work_s)
summary(lm7)
```

### Gesamte QQ-Skala
```{r}
lm8 <- lm(QQ_Gesamt_mean ~ PS_mean + BZG, data=d_work_s)
summary(lm8)
```
...
### QQ-Anand
```{r}
lm9 <- lm(QQ_Anand_mean ~ SL_mean + BZG, data=d_work_s)
summary(lm9)
```

### Gesamte QQ-Skala
```{r}
lm10 <- lm(QQ_Gesamt_mean ~ SL_mean + BZG, data=d_work_s)
summary(lm10)
```
