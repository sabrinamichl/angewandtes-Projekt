...
### Gesamte QQ-Skala
```{r}
lm10 <- lm(QQ_Gesamt_mean ~ SL_mean + Alter + Geschlecht + BZG + Gehalt, data=d_work_s)
summary(lm10)
```
...
## QQ_Anand
```{r}
lm11 <- moderate.lm(x=OC_A_mean, z=CPE_mean, y=QQ_Anand_mean, data=d_work_s,
                      mc=FALSE)
summary(lm11)
```

```{r}
simpleSlope_lm11 <- sim.slopes(mod=lm11, z=d_work_s$CPE_mean, zsd=1, mcz=FALSE)
```

```{r}
graph.mod(simpleSlope_lm11, x=OC_A_mean, y=QQ_Anand_mean, data=d_work_s, ylab="QQ", xlab="OCA")
```


## QQ_Gesamt
```{r}
lm12 <- moderate.lm(x=OC_A_mean, z=CPE_mean, y=QQ_Gesamt_mean, data=d_work_s,
                      mc=FALSE)
summary(lm12)
```

```{r}
simpleSlope_lm12 <- sim.slopes(mod=lm12, z=d_work_s$CPE_mean, zsd=1, mcz=FALSE)
```

```{r}
graph.mod(simpleSlope_lm12, x=OC_A_mean, y=QQ_Gesamt_mean, data=d_work_s, ylab="QQ", xlab="OCA")
```
...
## QQ_Anand
```{r}
lm13 <- moderate.lm(x=OC_A_mean, z=Alter, y=QQ_Anand_mean, data=d_work_s,
                      mc=FALSE)
summary(lm13)
```

```{r}
simpleSlope_lm13 <- sim.slopes(mod=lm13, z=d_work_s$Alter, zsd=1, mcz=FALSE)
```

```{r}
graph.mod(simpleSlope_lm13, x=OC_A_mean, y=QQ_Anand_mean, data=d_work_s, ylab="QQ", xlab="OCA")
```

## QQ_Gesamt
```{r}
lm14 <- moderate.lm(x=OC_A_mean, z=Alter, y=QQ_Gesamt_mean, data=d_work_s,
                      mc=FALSE)
summary(lm14)
```

```{r}
simpleSlope_lm14 <- sim.slopes(mod=lm14, z=d_work_s$Alter, zsd=1, mcz=FALSE)
```

```{r}
graph.mod(simpleSlope_lm14, x=OC_A_mean, y=QQ_Gesamt_mean, data=d_work_s, ylab="QQ", xlab="OCA")
```
...
## QQ_Anand
```{r}
lm15 <- moderate.lm(x=SL_mean, z=CPE_mean, y=QQ_Anand_mean, data=d_work_s,
                      mc=FALSE)
summary(lm15)
```

```{r}
simpleSlope_lm15 <- sim.slopes(mod=lm15, z=d_work_s$CPE_mean, zsd=1, mcz=FALSE)
```

```{r}
graph.mod(simpleSlope_lm15, x=SL_mean, y=QQ_Anand_mean, data=d_work_s, ylab="QQ", xlab="OCA")
```

## QQ_Gesamt
```{r}
lm16 <- moderate.lm(x=SL_mean, z=CPE_mean, y=QQ_Gesamt_mean, data=d_work_s,
                      mc=FALSE)
summary(lm16)
```

```{r}
simpleSlope_lm16 <- sim.slopes(mod=lm16, z=d_work_s$CPE_mean, zsd=1, mcz=FALSE)
```

```{r}
graph.mod(simpleSlope_lm16, x=SL_mean, y=QQ_Gesamt_mean, data=d_work_s, ylab="QQ", xlab="OCA")
```
